...
if __name__ == '__main__':
    ...
    for pt in range(0,3):
        for rho in range(0,4):
            ...
            linkdir='/uscms/home/jennetd/nobackup/hbb-prod-modes/CMSSW_10_2_13/src/vbf-ul/main-vbf/zbb-total/'
...
#                    initial_vals = (np.full((1,0),1)).tolist()
#                    thedict = {}
#                    thedict["initial_vals"] = initial_vals
...
#                        json.dump(thedict,outfile)
            ...
            # Run the first fit
            combine_cmd = "combineTool.py -M MultiDimFit -m 125 \
            -d output/testModel_"+year+"/model_combined.root --saveWorkspace \
            -P rZbb --floatOtherPOIs=0 -n \"Snapshot\" \
            --robustFit=1 --cminDefaultMinimizerStrategy=0 --setParameters rZbb=1"
